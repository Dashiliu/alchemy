...
public class UploadController {
    ...
    public ResponseEntity<JarInfo> confs(@RequestParam("file") MultipartFile file,
        @PathVariable(value = "jobId") Long jobId) throws IOException {
        ...
        return new ResponseEntity<>(jarInfo, HeaderUtil.createAlert("upload a jar ", null), HttpStatus.OK);
    }
