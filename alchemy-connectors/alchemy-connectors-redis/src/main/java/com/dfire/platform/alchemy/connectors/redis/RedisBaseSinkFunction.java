 ...
 * @date 07/06/2018
 */
public abstract class RedisBaseSinkFunction extends RichSinkFunction<Tuple2<Boolean, Row>> {
    ...
    public RedisBaseSinkFunction(String[] fieldNames, TypeInformation<?>[] fieldTypes,
    ...
    private void sendLpushCommand(String key, Row row) {
        ...
        for (int i = 0; i < fieldNames.length; i++) {
            ...
            values.add(row.getField(i).toString());
        }
